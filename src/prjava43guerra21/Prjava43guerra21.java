package prjava43guerra21;
import java.awt.*;        // using AWT containers and components
import java.awt.event.*;  // using AWT events and listener interfaces
import java.io.*;
 
// An AWT GUI program inherits the top-level container java.awt.Frame
public class Prjava43guerra21 extends Frame
   ...
   public Prjava43guerra21 () {
      ...
      setTitle("nova finestra prjava43guerra21");  // "this" Frame sets title
   ...
   public static void main(String[] args) {
      new Prjava43guerra21();  // Let the construct do the job
   }
